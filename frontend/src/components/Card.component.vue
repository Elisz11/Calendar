...
<template>
    <div class="fixed inset-0 bg-[rgba(0,0,0,0.5)] z-50 flex items-center justify-center" @click.self="close">
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-stone-800 p-6 rounded-lg shadow-lg">
            ...
            <form class="flex flex-col text-white">
                ...
                <label>Type</label>
                <select class="border" v-model="localCard.type" required>
                ...
                <select class="border" v-model="localCard.progress" required>
